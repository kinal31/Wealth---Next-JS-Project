                ...
                return await db.transaction.findMany({
                    where: {
                        ...
                        OR: [
                            ...
                            {
                                nextRecurringDate: {
                                    lte: new Date(), //due date passed ex: nextRecurringDate <= today :  25/1<= 26/12
                                },
                            },
                        ],
                    },
...
async function generateFinancialInsight(stats, month) {
...
export async function getMonthlyStats(userId, month) {
    ...
    return transactions.reduce(
        (stats, t) => {                             // intial stats={totalExpenses: 0,... }
            ...
            if (t.type === "EXPENSE") {
                ...
                // byCategory: {
                //     "Food": 300,       // Total expenses for "Food" category
                //     "Entertainment": 200,  // Total expenses for "Entertainment" category
                //   },
            } else {
